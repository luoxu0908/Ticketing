...
$(document).ready(function () {
	...
	SGH = new SlickGridHelper(
		"#myGrid",
		"FL.MeansTestDeclarationformListing",
		{
		...
		{
			AddSelColumn: false,
			GetDataURL: apiSrc+"/FL1.MeansTestDeclarationformListing_Get.json",
			AddRowURL: "",
			DelRowURL: "",
			UpdRowURL: "",
			UpdRowFldURL: "",
	...
	var pageInit = $.JSONPost(apiSrc+"/FL1.MeansTestDeclarationformListing_Get.json", {});
